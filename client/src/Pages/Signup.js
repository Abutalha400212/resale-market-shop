...
const Signup = () => {
  // const { createUser, updateUser, googleLogin, loading } =
  ...
  const handleSignup = (data) => {
    ...
    //       .then((result) => {
    //         updateUser(data.name, Imgdata.data.display_url).then(() => {
    //           mutate(user);
    //         });
    //       })
  ...
  return (
    <div className="h-[calc(100vh-36px)] grid place-content-center place-items-center">
