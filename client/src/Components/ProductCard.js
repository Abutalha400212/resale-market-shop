...
const ProductCard = ({ item, setHandleShop }) => {
  ...
  // const { mutate, isLoading, isSuccess } = useUpdateProduct(onSuccess);
  // if (isLoading && isSuccess) {
  //   return <Loader />;
  // }
  // const handleAdvertiseItem = (item) => {
  //   delete item._id;
  //   const jobId = _id;
  //   mutate({ ...item, jobId });
  // };
  ...
  return (
    <div class="relative m-10 flex w-full md:max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md ">
